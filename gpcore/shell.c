				...
				if (param2.present)
				{
					if (param2.type == TOKEN_INT)
					{
						...
						if (0 <= intparam2 && intparam2 <= 255)
						{
							...
							snprintf(buf, size, "UP,%c,%d" CMDEND, param1.value.letter, intparam2);
							mcuicom_send(buf);
						}
						else
						{
				...
				if (param2.present)
				{
					if (param2.type == TOKEN_INT)
					{
						...
						if (0 <= intparam2 && intparam2 <= 255)
						{
							...
							snprintf(buf, size, "UI,%c,%d" CMDEND, param1.value.letter, intparam2);
							mcuicom_send(buf);
						}
						else
						{
	...
	if (param1.present)
	{
		if (param1.type == TOKEN_LETTER)
		{
			if ('A' <= param1.value.letter && param1.value.letter <= 'F')
			{
				...
				snprintf(buf, size, "WD,%c" CMDEND, param1.value.letter);
				mcuicom_send(buf);
	...
	if (param1.present)
	{
		if (param1.type == TOKEN_LETTER)
		{
			if ('A' <= param1.value.letter && param1.value.letter <= 'F')
			{
				...
				snprintf(buf, size, "WI,%c" CMDEND, param1.value.letter);
				mcuicom_send(buf);
